...
set_target_properties(FAudio::FAudio PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libFAudio.so.0.21.03"
  IMPORTED_SONAME_RELEASE "libFAudio.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS FAudio::FAudio )
list(APPEND _IMPORT_CHECK_FILES_FOR_FAudio::FAudio "${_IMPORT_PREFIX}/lib/libFAudio.so.0.21.03" )
